...
KnitTools is an Android/Kotlin app for knitting projects, counters, pattern documents, photos, local keyword voice commands, Ravelry integration, billing, and home-screen widgets.

High-value user data:
- Project names, row/stitch counters, progress notes, pattern instructions, local voice transcripts, and imported pattern documents.
...
- Model-backed parsing, AI help, OCR, and conversational voice are intentionally absent; do not reintroduce them without a new product/security decision.
...
- Logs must not include user project data, counters, pattern text, voice transcripts, billing details, Ravelry tokens, OAuth codes, or credentials.
