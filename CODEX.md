...
- Voice commands are local keyword commands under `ui/screens/counter`; do not reintroduce model-backed fallback or conversational voice without a new explicit product/security decision
